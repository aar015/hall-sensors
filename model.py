...
def analyze_all():
    ...
    epilayer.plot_mag_vs_freq(chosen_i=1e-3, label1='Epilayer 10mm', label2=None)
    ...
    epilayer.plot_phase_vs_freq(chosen_i=1e-3, label1='Epilayer 10mm', label2=None)
    ...
    epilayer.plot_mag_vs_mag(chosen_i=1e-3, label1='Epilayer 10mm', label2=None)
    ...
    epilayer.plot_phase_vs_mag(chosen_i=1e-3, label1='Epilayer 10mm', label2=None)
    ...
    epilayer.plot_error_vs_freq(chosen_i=1e-3, label='Epilayer 10mm')
    plt.legend()
    ...
    epilayer.plot_error_vs_mag(chosen_i=1e-3, label='Epilayer 10mm')
    plt.legend()
